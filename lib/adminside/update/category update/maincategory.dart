...
import 'package:sahoolar_bazar/adminside/update/category%20update/show_category.dart';
...
class MainProductCategory extends StatelessWidget {
  @override
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => ShowCategoryAdminPageUpdate(
                                  title: e.name,
                                )));
                  },
                  child: Container(
