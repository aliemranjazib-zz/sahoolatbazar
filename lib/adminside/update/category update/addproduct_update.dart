...
class AddProductAdminPageUpdate extends StatefulWidget {
  String title;
  String id;

  AddProductAdminPageUpdate({this.title, this.id});
  @override
  _AddProductAdminPageUpdateState createState() =>
      _AddProductAdminPageUpdateState();
}

class _AddProductAdminPageUpdateState extends State<AddProductAdminPageUpdate> {
  ...
  uploadToFirebase() async {
    ...
    await db.collection("products").doc(widget.id).update({
      'name': nameC.text,
