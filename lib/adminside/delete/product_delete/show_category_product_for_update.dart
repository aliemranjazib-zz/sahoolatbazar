...
import 'package:sahoolar_bazar/adminside/delete/product_delete/show_product_for_delete.dart';
...
class ShowCategoryProductForDelete extends StatelessWidget {
  String title;
  ShowCategoryProductForDelete({this.title});
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (c) => ShowProductPageForDelete(
                                          title: data['title'])));
                            },
                            child: Column(
                              children: [
